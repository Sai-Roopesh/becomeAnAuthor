...
fn resolve_series_for_restored_project(
    ...
    if let Ok(Some(restored)) = crate::commands::series::restore_or_recreate_deleted_series(original_series_id) {
        return Ok(restored);
    }
...
pub type LegacyProjectRow = (String, Option<String>, String, String, i32, Option<String>);

fn flatten_structure_nodes(
    nodes: &[StructureNode],
    parent_id: Option<&str>,
    output: &mut Vec<LegacyProjectRow>,
) {
