...
fn resolve_series_for_restored_project(
    ...
    if let Ok(Some(restored_series_id)) =
...
type ProjectStructureNodeTuple = (String, Option<String>, String, String, i32, Option<String>);

fn flatten_structure_nodes(
    nodes: &[StructureNode],
    parent_id: Option<&str>,
    output: &mut Vec<ProjectStructureNodeTuple>,
) {
