...
fn resolve_series_for_restored_project(
    ...
    // Attempt to recreate the deleted series from the registry before falling back to Recovery series
...
type StructureNodeFlatData = (String, Option<String>, String, String, i32, Option<String>);

fn flatten_structure_nodes(
    nodes: &[StructureNode],
    parent_id: Option<&str>,
    output: &mut Vec<StructureNodeFlatData>,
) {
