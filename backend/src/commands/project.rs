...
fn resolve_series_for_restored_project(
    ...
    if let Some(restored_id) = restore_or_recreate_deleted_series(original_series_id)? {
...
type FlattenedStructureOutput =
    Vec<(String, Option<String>, String, String, i32, Option<String>)>;
