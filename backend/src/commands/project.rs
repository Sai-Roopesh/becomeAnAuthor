...
fn resolve_series_for_restored_project(
    ...
    if let Ok(Some(restored_series_id)) = crate::commands::series::restore_or_recreate_deleted_series(original_series_id) {
...
pub type FlattenedStructureNode = (String, Option<String>, String, String, i32, Option<String>);
