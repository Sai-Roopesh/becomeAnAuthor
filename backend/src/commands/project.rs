...
fn resolve_series_for_restored_project(
    ...
    // Try to restore or recreate from deleted series registry
...
fn flatten_structure_nodes(
    ...
    #[allow(clippy::type_complexity)] output: &mut Vec<(String, Option<String>, String, String, i32, Option<String>)>,
) {
