...
| `DocumentExportService` | `DocumentExportService.ts` | ~1260 | Multi-format export engine with Export Config V2: PDF (@react-pdf/renderer), DOCX (docx npm), Markdown. Supports custom styling, margins, and template variables. |
