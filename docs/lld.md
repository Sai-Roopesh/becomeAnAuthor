...
| `DocumentExportService` | `DocumentExportService.ts` | ~1260 lines | Full manuscript export (DOCX, PDF via @react-pdf/renderer, Markdown) with Export Config V2, custom margins, and template support. |
...
| **dashboard** | 6 | 0 | Project grid, cards, empty state, header, trash management with action locks (pendingProjectAction/pendingSeriesAction) |
