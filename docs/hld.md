...
| **Export** | 1 | 2 | Multi-format manuscript export (DOCX, EPUB, PDF via @react-pdf/renderer, Markdown, plain text) with Config V2 |
...
| **Other** | 5 modules | ~12 | Snippets, ideas, scene notes, world maps, world events |
