...
>((props, ref) => {
  ...
  return (
    <Card className="p-1 max-h-80 overflow-auto shadow-lg border min-w-menu-lg">
      ...
      {/* Footer hint */}
      <div className="mt-1 px-3 py-1.5 border-t text-2xs text-muted-foreground flex items-center gap-2">
        <kbd className="px-1 py-0.5 bg-muted rounded text-2xs">↑↓</kbd>
        <span>navigate</span>
        <kbd className="px-1 py-0.5 bg-muted rounded text-2xs">↵</kbd>
        <span>select</span>
        <kbd className="px-1 py-0.5 bg-muted rounded text-2xs">esc</kbd>
        <span>close</span>
      </div>
    </Card>
  );
