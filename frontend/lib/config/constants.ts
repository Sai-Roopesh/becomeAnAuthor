...
export const TEMPLATE_VARIABLES = {
    ...
    year: { key: '{{year}}', label: 'Current Year', placeholder: new Date().getFullYear().toString() },
    date: { key: '{{date}}', label: 'Current Date', placeholder: new Date().toLocaleDateString() },
    wordCount: { key: '{{wordCount}}', label: 'Total Word Count', placeholder: '0' },
} as const;
 ...
 */
export const AI_PROVIDER_ENDPOINTS: Record<string, string> = {
