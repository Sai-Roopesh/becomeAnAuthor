...
export interface AnalysisInsight {
  id: string;
  type: "positive" | "warning" | "error" | "info";
  category: "plot" | "character" | "timeline" | "world" | "other";
  message: string;
  severity: 1 | 2 | 3;
  autoSuggest?: string;
  sceneReferences?: {
...
export interface StoryAnalysis {
  id: string;
  projectId: string;
  analysisType: "synopsis" | "plot-threads" | "character-arcs" | "timeline" | "contradictions" | "alpha-reader" | "beta-reader";
  scope: "full" | "act" | "chapter" | "scene";
  scopeIds: string[];
  results: ParsedAnalysisResult;
