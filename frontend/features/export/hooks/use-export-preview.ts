...
import type { ExportPreset, ExportConfig, PreviewPage } from '@/domain/types/export-types';
...
export function useExportPreview(projectId: string) {
    ...
    const generatePreview = useCallback(async (
        ...
        setError(null);
        try {
            const pages = await exportService.generatePreview(projectId, preset, customConfig);
            setPreview(pages);
