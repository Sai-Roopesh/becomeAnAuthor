...
export function AIConnectionsTab() {
    ...
    const handleRefreshModels = async () => {
        ...
        try {
            ...
            await saveConnection(selectedId, {
                ...
                ...(selectedConnection.customEndpoint && { customEndpoint: selectedConnection.customEndpoint }),
            });
        } catch (err) {
    ...
    const vendor = selectedConnection ? AI_VENDORS[selectedConnection.provider] : null;
