...
export function WorldTimelineView({ projectId }: WorldTimelineViewProps) {
  ...
  const eventsByEra = useMemo(() => {
    ...
    const sortedEvents = [...events].sort(
      (a, b) =>
        worldEventTemporalSortValue(a.temporal) -
        worldEventTemporalSortValue(b.temporal),
    );
    ...
    <div className="h-full flex flex-col">
                          ...
                          <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                            <div className="flex-1">
                              <div className="flex items-center gap-2 mb-1">
                                <Badge
                                  className={cn("gap-1", categoryConfig.color)}
                                >
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="max-w-lg">
          <DialogHeader>
            <DialogTitle>
              {editingEvent?.createdAt === editingEvent?.updatedAt
                ? "Add World Event"
                : "Edit World Event"}
            </DialogTitle>
          </DialogHeader>
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setEditingEvent({ ...editingEvent, era: e.target.value })
                    }
                ...
                <div>
                  ...
                  <WorldEventTemporalField
                    ...
                    onChange={(temporal) =>
                      setEditingEvent({ ...editingEvent, temporal })
                    }
                  />
                </div>
              </div>
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(v) =>
                      setEditingEvent({
                        ...editingEvent,
                        category: v as WorldEventCategory,
                      })
                    }
                  >
                    <SelectTrigger>
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(v) =>
                      setEditingEvent({
                        ...editingEvent,
                        importance: v as WorldEvent["importance"],
                      })
                    }
                  >
                    <SelectTrigger>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="world-changing">
                        World-Changing
                      </SelectItem>
                    </SelectContent>
                  </Select>
      ...
      <AlertDialog
        ...
        onOpenChange={(open) => !open && setDeleteEventConfirm(null)}
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Delete Event</AlertDialogTitle>
            <AlertDialogDescription>
              Are you sure you want to delete &quot;{deleteEventConfirm?.title}
