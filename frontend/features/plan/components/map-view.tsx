...
import { Map, Upload, MapPin, Trash2, ZoomIn, ZoomOut } from "lucide-react";
...
import { MARKER_COLORS, DEFAULT_MARKER_COLOR } from "@/shared/constants/colors";
...
// MARKER_COLORS imported from @/shared/constants/colors
...
export function MapView({ projectId, seriesId }: MapViewProps) {
  ...
  const [deleteMapConfirm, setDeleteMapConfirm] = useState<{
    id: string;
    name: string;
  } | null>(null);
  ...
  return (
    <div className="h-full flex flex-col">
            ...
            {maps.map((map) => (
              ...
              >
                ...
                <Button
                  variant="ghost"
                  size="icon"
                  className="h-4 w-4 ml-1 opacity-100 sm:opacity-0 sm:group-hover:opacity-100 sm:group-focus-within:opacity-100 transition-opacity"
                  onClick={(e) => {
                    e.stopPropagation();
                  ...
                  >
                    ...
                    >
                      <MapPin
                        ...
                        style={{ color: marker.color || DEFAULT_MARKER_COLOR }}
      ...
      <AlertDialog
        ...
        onOpenChange={(open) => !open && setDeleteMapConfirm(null)}
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Delete Map</AlertDialogTitle>
            <AlertDialogDescription>
              Are you sure you want to delete &quot;{deleteMapConfirm?.name}
