...
export function ArcPointEditor({
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-3xl h-[90dvh] sm:h-[85dvh] flex flex-col overflow-hidden">
        <DialogHeader>
          <DialogTitle>
        ...
        <div className="flex-1 min-h-0 space-y-4 overflow-y-auto py-4 pr-1">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) =>
                setFormData((prev) => ({ ...prev, sceneId: e.target.value }))
              }
            />
            <p className="text-xs text-muted-foreground">
              Linking to a scene allows AI to know character state exactly at
              that point
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <p className="text-xs text-muted-foreground">
              Track character attributes over time
            </p>
          ...
          <Collapsible className="border rounded-lg p-4">
            ...
            <CollapsibleContent className="space-y-3 pt-3">
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-xs text-muted-foreground">
                  Critical for preventing plot holes - AI won't reveal this
                  early
                </p>
              </div>
