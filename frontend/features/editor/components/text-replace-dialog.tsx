...
export function TextReplaceDialog({
  action,
  selectedText,
  editor,
  onClose,
    ...
    <Dialog open={true} onOpenChange={onClose}>
      ...
      >
        ...
        <Tabs
          ...
          onValueChange={(v) =>
            dispatch({ type: "SWITCH_TAB", payload: v as "tweak" | "preview" })
          }
        ...
        >
          <div className="flex-none px-6 pt-2">
            <TabsList className="w-full grid grid-cols-2">
              ...
              <TabsTrigger value="preview" disabled={!state.result}>
                👁️ Preview
              </TabsTrigger>
            </TabsList>
          </div>
          ...
          >
                ...
                <SelectContent>
                  ...
                  {action === "rephrase" && (
                    <>
                      ...
                      <SelectItem value="add inner thoughts">
                        Add inner thoughts
                      </SelectItem>
                      <SelectItem value="convert to dialogue">
                        Convert to dialogue
                      </SelectItem>
                      <SelectItem value="passive to active voice">
                        Passive → Active
                      </SelectItem>
                      <SelectItem value="use different words">
                        Use different words
                      </SelectItem>
                      <SelectItem value="show don't tell">
                        Show, don't tell
                      </SelectItem>
                    </>
                  )}
            ...
            <div>
              ...
              <Textarea
                ...
                onChange={(e) =>
                  dispatch({ type: "SET_INSTRUCTION", payload: e.target.value })
                }
          ...
          >
            ...
            <div>
              ...
              <Textarea
                value={state.result}
                onChange={(e) =>
                  dispatch({ type: "SET_RESULT", payload: e.target.value })
                }
                className="flex-1 mt-2"
