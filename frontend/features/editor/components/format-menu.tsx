    ...
    <div className="p-4">
      <Tabs defaultValue="focus">
        <TabsList className="grid w-full grid-cols-3">
          <TabsTrigger value="focus" aria-label="Focus">
            Focus
          </TabsTrigger>
          <TabsTrigger value="typography" aria-label="Typography">
            Typography
          </TabsTrigger>
          <TabsTrigger value="page" aria-label="Page">
            Page
          </TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="focus" className="space-y-4 mt-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(checked) =>
                updateSettings({ typewriterMode: checked })
              }
            />
          </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                AI continues within chapter context
              </p>
            </div>
            <Switch
              checked={continueInChapter}
              onCheckedChange={(checked) =>
                updateSettings({ continueInChapter: checked })
              }
            />
          </div>
        </TabsContent>
        ...
        <TabsContent value="typography" className="space-y-4 mt-4">
          ...
          <div className="space-y-2">
            ...
            <Slider
              value={[fontSize]}
              onValueChange={([v]) =>
                v !== undefined && updateSettings({ fontSize: v })
              }
          ...
          <div className="space-y-2">
            ...
            <Slider
              value={[lineHeight]}
              onValueChange={([v]) =>
                v !== undefined && updateSettings({ lineHeight: v })
              }
              min={1.0}
              max={3.0}
              step={0.1}
          ...
          <div className="space-y-2">
            ...
            <Select
              value={alignment}
              onValueChange={(v: "left" | "center" | "right" | "justify") =>
                updateSettings({ alignment: v })
              }
            >
              <SelectTrigger>
                <SelectValue />
        ...
        <TabsContent value="page" className="space-y-4 mt-4">
          ...
          <div className="space-y-2">
            ...
            <Slider
              value={[pageWidth]}
              onValueChange={([v]) =>
                v !== undefined && updateSettings({ pageWidth: v })
              }
