      ...
      <div className="relative z-10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 min-w-0">
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className="text-sm text-muted-foreground truncate">Your novels await</p>
          </div>
        </div>

        <div className="flex items-center gap-2 text-sm text-muted-foreground italic sm:max-w-md min-w-0">
          <Sparkles className="w-4 h-4 text-primary/50 flex-shrink-0" />
          <span className="line-clamp-1 break-words">"{quote}"</span>
        </div>
      </div>
    </div>
  );
